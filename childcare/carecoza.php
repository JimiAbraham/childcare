...
echo '<h2 style: margin-left: 10px; display: inline;>Total Children = '. $rs[0].'</h2>';  ?>
<p>Total Male = <b><?php echo $rm[0];?></b> , Total Female = <b><?php  echo $rg[0];?></b> </p> 
<p>Total Age (0yr - 7yrs) = <b><?php echo $rt[0];?></b> , Total Age (7yrs and above) = <b><?php  echo $rr[0];?></b> </p>   
      ...
      <table cellpadding="5" cellspacing="1" style='width: 85%;'>
        <thead>
          ...
          <th style="padding: 10px;"><strong>Surname</strong></th>          
          <th style="padding: 10px;"><strong>Name</strong></th>
          <th style="padding: 10px;"><strong>Gender</strong></th>
          <th style="padding: 10px;"><strong>Parent NUMBER</strong></th>
          <th style="padding: 10px;"><strong>Age</strong></th>
          <th style="padding: 10px;"><strong>Photo</strong></th>
...
?>          <td style="padding: 10px;"><?php echo $c; ?></td>
          ...
          <td>
          <a  href="reg.php?id=<?php echo $result[$k]["id"]; ?>" title="Sign In" class="btnDeleteAction">Sign In</a>
           <a class="btnDeleteAction" href="edit.php?id=<?php echo $result[$k]["id"]; ?>">Edit</a>
           <a href="delete.php?action=delete&id=<?php echo $result[$k]["id"]; ?>" title="delete" class="btnDeleteAction" onclick="return confirm('Are you sure you want to delete this child?)">Delete</a>
