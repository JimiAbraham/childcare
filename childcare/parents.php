...
<?php  
 ...
 echo '<h2 style: margin-left: 10px; display: inline;>Total Parents = '. $rs[0].'</h2>';  ?>
      ...
      <div class="box">
      <p style="padding: 10px;"><input type="text" placeholder="Name" name="search[Pname]" class="demoInputBox" value="<?php echo $Pname; ?>" /><input type="text" placeholder="Phone Number" name="search[phone]" class="demoInputBox" value="<?php echo $phone; ?>" /><input type="submit" name="go" class="btnSearch" value="Search"><input type="reset" class="btnSearch" value="Reset" onclick="window.location ='parents.php'"></p>
      </div>
      ...
      <table cellpadding="5" cellspacing="1" style='width: 85%;'>
        <thead>
          ...
          <th style="padding: 10px;"><strong>Parent Name</strong></th>          
          <th style="padding: 10px;"><strong>Address</strong></th>
          <th style="padding: 10px;"><strong>Department</strong></th>
          <th style="padding: 10px;"><strong>Parent NUMBER</strong></th>
          <th style="padding: 10px;"><strong>Email</strong></th>
          <th style="padding: 10px;"><strong>Child Name</strong></th>
          
          <th style="padding: 10px;"><strong>Action</strong></th>
        ...
        <tbody>
         ...
         <td style="padding: 10px;"><?php echo $out; ?></td>
          ...
          <a  href="tel:?<?php echo $result[$k]["phone"]; ?>" title="Call" class="btnDeleteAction">Call</a>
           <a href="delet.php?action=delete&Pid=<?php echo $result[$k]["Pid"]; ?>" title="delete" class="btnDeleteAction" onclick="return confirm('Are you sure you want to delete this Parent')">Delete</a>
    ...
    <article style="display: block;" id="parents">
      ...
      <center><h6><a href="aparents.php">Come here to see more advanced PARENT analysis</a></h6></center>
    </article>
